...
コーディングに関する規約は `.agents/requirements/` 配下に配置している。ファイル一覧と内容は `.agents/requirements/README.md` を参照すること。

### 主要なスキルセット

各種スキルセットは `.agents/skills/` 配下に配置している。スキル一覧と内容は `.agents/skills/README.md` を参照すること。
