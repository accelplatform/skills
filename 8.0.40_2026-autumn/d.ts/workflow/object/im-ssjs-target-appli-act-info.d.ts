 ...
 * 特定業務代理先情報オブジェクト。
 *
 * 特定業務代理先一覧の取得結果を保存します。
 * データベーステーブル「imw_t_act」のデータが設定されます。
 * 特定業務情報であるフロー関連情報は「imw_m_flow」のデータが設定されます。
 *
 * 値の取得時にのみ使用します（新規作成・更新・削除には使用しません）。
 *
 * @since 8.0.37 (2025 Spring)
 * @see https://api.intra-mart.jp/iap/apilist-ssjs/doc/im_workflow/TargetAppliActInfo/index.html
 */
interface TargetAppliActInfo {
  // --- NOT NULL プロパティ ---
