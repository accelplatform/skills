...
- `.agents/requirements/jssp-presentation-page/AGENTS.md` - プレゼンテーションページの基本構造
- `.agents/skills/jssp-localize-support/` 関連 - 多言語化（読み上げ言語）
- `.agents/skills/jssp-imds-theme/reference/` - imds コンポーネント別のアクセシビリティ対応
