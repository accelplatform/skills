...
- `.agents/requirements/jssp-presentation-page/AGENTS.md` - Basic structure of presentation pages
- `.agents/skills/jssp-localize-support/` related - Multilingual support (spoken language)
- `.agents/skills/jssp-imds-theme/reference/` - Accessibility support per imds component
