...
3. `{{AGENT_RULES}}/jssp-testing.instructions.md` のテスト観点に基づいてテストケースを設計する
4. `assets/` 配下の実例コードを参照してテストコードを生成する
...
| `{{AGENT_RULES}}/jssp-testing.instructions.md` | テスト観点・設定規約 |
...
- テスト観点の詳細は `{{AGENT_RULES}}/jssp-testing.instructions.md` を参照すること
