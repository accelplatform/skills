...
3. 根据 `{{AGENT_RULES}}/jssp-testing.instructions.md` 的测试观点设计测试用例
4. 参考 `assets/` 目录下的示例代码生成测试代码
...
| `{{AGENT_RULES}}/jssp-testing.instructions.md` | 测试观点和配置规范 |
...
- 测试观点的详情请参考 `{{AGENT_RULES}}/jssp-testing.instructions.md`
