...
|---------|-----------------|------|---------|
| キャプション | `caption_<locale>.properties` | タイトル、ラベル、ボタン名等の短い表示文字列 | `CAP.Z.IWP.<製品名>.<機能名>.<キャプション名>` |
| メッセージ | `message_<locale>.properties` | エラーメッセージ、確認メッセージ、成功メッセージ等 | `MSG.<エラータイプ>.IWP.<製品名>.<機能名>.<メッセージ名>` |
| ログメッセージ | `log-message_<locale>.properties` | Logger 出力用メッセージ | `<エラータイプ>.IWP.<製品名>.<機能名>.<連番>` |
