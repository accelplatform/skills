...
詳細は `instructions/jssp-error-handling.instructions.md` および `jssp-page-generator/reference/post-generation-verification.md`（ステップ 3-7: Transaction.begin の戻り値チェック）も参照。
