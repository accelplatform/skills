...
`.github/skills/jssp-tenant-setup-generator/reference/checklist.md` (apply the substitutions listed under "Substitutions to apply when reading those references" in SKILL.md).
...
- [ ] It complies with `.github/instructions/jssp-code-style.instructions.md` (declare variables with `let`, do not use `var`, use single quotes for strings)
