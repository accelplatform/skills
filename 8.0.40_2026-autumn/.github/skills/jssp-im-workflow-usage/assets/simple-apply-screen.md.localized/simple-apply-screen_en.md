# Workflow Application Screen Template
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      function buildMatterName() {
        return 'PartsOrderApplication_' + $data.result.partCode;
      }
...
- **Implement validation according to the conventions in `{{AGENT_RULES}}/jssp-presentation-page.instructions.md`** (key rules below):
