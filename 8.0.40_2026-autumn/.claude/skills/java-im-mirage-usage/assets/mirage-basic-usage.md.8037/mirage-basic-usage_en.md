...
Follow the conventions in `.claude/rules/java-entity.md` (public fields, no-argument constructor, the 4 audit fields).
...
- This project uses only `GenerationType.APPLICATION` for the `generationType` of `@PrimaryKey` (see `.claude/rules/java-entity.md`)
