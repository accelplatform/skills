...
> The essential points of the convention (guardrails) are summarized in `.claude/rules/java-service-layer.md`. This skill is referenced from there and provides the complete code templates.
...
- `.claude/rules/java-service-layer.md` - Convention summary for this skill (always reference)
- `.claude/rules/java-architecture.md` - Architecture principles and layer structure
- `.claude/rules/java-entity.md` - Entity and domain model definitions
- `.claude/rules/java-logging.md` - Logging implementation rules
