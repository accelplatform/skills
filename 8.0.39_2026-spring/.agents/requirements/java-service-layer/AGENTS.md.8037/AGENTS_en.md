...
The service layer implements business logic and orchestrates operations that span multiple repositories. See `java-architecture/AGENTS.md` for the overall layer structure.
...
See `.agents/skills/java-im-service-layer/references/StandardServiceTemplate.java` for the full template.
...
See `.agents/skills/java-im-service-layer/references/MultiRepositoryServiceTemplate.java` for an example that handles multiple repositories in a single transaction.
...
- Exception messages must be in Japanese and include variable values needed for troubleshooting. See `java-logging/AGENTS.md` for whether/at what level to log
...
- `java-architecture/AGENTS.md` - Architecture principles and layer structure
- `java-entity/AGENTS.md` - Entity class conventions
- `java-logging/AGENTS.md` - Logging conventions
- See `.agents/skills/java-im-service-layer/SKILL.md` for the full service implementation templates
