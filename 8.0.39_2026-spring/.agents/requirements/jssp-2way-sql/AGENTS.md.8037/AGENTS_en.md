...
- `.agents/requirements/jssp-security/AGENTS.md` - Overall SQL injection prevention policy
- `.agents/skills/jssp-page-generator/reference/api-database.md` - Database API reference
