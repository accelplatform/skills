...
- 詳細は `.agents/skills/jssp-jest-test/SKILL.md` を参照すること
...
Playwright テストでは `.agents/skills/jssp-playwright-test/assets/test-helpers.md` の `expectNavigated()` ヘルパー使用を推奨する。
