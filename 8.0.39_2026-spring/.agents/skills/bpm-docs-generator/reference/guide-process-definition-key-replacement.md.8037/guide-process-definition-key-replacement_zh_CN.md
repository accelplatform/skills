...
- 执行示例：`{{RUNTIME}} .agents/skills/bpm-docs-generator/scripts/validate-process-key-replacement.js <processNm-prompt/diagram.bpmn> --json`
...
- 反映时的既有键复用・例外时的处理・记录更新，以 bpm-xml-reflector 的 `.agents/skills/bpm-xml-reflector/reference/bpmn-specs-reflector.md` 为准。
