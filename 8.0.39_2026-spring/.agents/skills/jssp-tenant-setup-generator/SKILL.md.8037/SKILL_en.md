...
Those go under `src/main/jssp/src/{feature}/sql/` (see `.agents/requirements/jssp-2way-sql/AGENTS.md`).
...
```bash
node .agents/skills/jssp-tenant-setup-generator/scripts/build-setup-import.js \
     <path to spec.json>
```
