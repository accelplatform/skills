...
```bash
node .agents/skills/jssp-im-logic-generator/scripts/build-flow.js <spec.json> --zip
```
...
```bash
node .agents/skills/jssp-im-logic-generator/scripts/validate-flow.js \
...
`.agents/skills/jssp-tenant-setup-generator/reference/imw-logic-plugin-import.md` を参照。
