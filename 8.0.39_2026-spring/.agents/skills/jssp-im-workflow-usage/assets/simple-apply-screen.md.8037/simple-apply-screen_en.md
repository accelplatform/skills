...
<imart type="workflowOpenPage"
  ...
  <!-- Page overall container (no id, since it is placed inside the intra-mart theme's imui-container) -->
...
- **Implement validation according to the conventions in `.agents/requirements/jssp-presentation-page/AGENTS.md`** (key rules below):
