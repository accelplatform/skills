...
```bash
node .agents/skills/test-spec-generator/scripts/build-test-spec.js <path to spec.json> [--out <output.xlsx>]
```
...
```bash
node .agents/skills/test-spec-generator/scripts/build-test-spec-html.js <path to spec.json> [--out <output.html>]
```
