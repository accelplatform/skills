...
```bash
node .agents/skills/test-spec-generator/scripts/build-test-spec.js <spec.jsonのパス> [--out <output.xlsx>]
```
...
```bash
node .agents/skills/test-spec-generator/scripts/build-test-spec-html.js <spec.jsonのパス> [--out <output.html>]
```
