...
```bash
node .agents/skills/test-spec-generator/scripts/build-test-spec.js <spec.json路径> [--out <output.xlsx>]
```
...
```bash
node .agents/skills/test-spec-generator/scripts/build-test-spec-html.js <spec.json路径> [--out <output.html>]
```
