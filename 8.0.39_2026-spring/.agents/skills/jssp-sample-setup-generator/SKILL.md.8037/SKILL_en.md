...
| Content | Reference |
|---|---|
| Role definition XML | `.agents/skills/jssp-tenant-setup-generator/reference/role.md` |
| Authz policy XML | `.agents/skills/jssp-tenant-setup-generator/reference/authz-policy.md` |
| Authz resource / resource group XML | `.agents/skills/jssp-tenant-setup-generator/reference/authz-resource.md` |
| Authz subject group XML | `.agents/skills/jssp-tenant-setup-generator/reference/authz-subject-group.md` |
| Menu group XML | `.agents/skills/jssp-tenant-setup-generator/reference/menu-group.md` |
| Job Scheduler XML | `.agents/skills/jssp-tenant-setup-generator/reference/job-scheduler.md` |
| DDL type mapping | `.agents/skills/jssp-tenant-setup-generator/reference/database-sql.md` |
...
```bash
node .agents/skills/jssp-sample-setup-generator/scripts/build-sample-setup-import.js \
     <path to spec.json>
```
...
- The `subject` expression in authz policies (e.g. `S(b_m_role:...)`) is **not content-validated by the build script**. Always check the format in `.agents/skills/jssp-tenant-setup-generator/reference/authz-policy.md`.
