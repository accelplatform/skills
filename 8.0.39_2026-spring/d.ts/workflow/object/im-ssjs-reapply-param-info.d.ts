 ...
 * 再申請用パラメータ情報オブジェクト。
 *
 * 再申請処理を行う際に必要なパラメータデータを保持します。
 * ProcessManager#reapply() に引数として渡します。
 *
 * @since 8.0.37 (2025 Spring)
 * @see https://api.intra-mart.jp/iap/apilist-ssjs/doc/im_workflow/ReapplyParamInfo/index.html
 */
interface ReapplyParamInfo {
  // --- 必須項目 ---
