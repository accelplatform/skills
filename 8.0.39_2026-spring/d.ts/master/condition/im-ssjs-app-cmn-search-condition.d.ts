 ...
 * @see https://api.intra-mart.jp/iap/apilist-ssjs/doc/im_master/AppCmnSearchCondition/index.html
 */
declare class AppCmnSearchCondition {
  // --- 論理演算子 ---
  ...
  /** 検索対象カラム CODE1 */
  static readonly CODE1: string;
  /** 検索対象カラム CODE2 */
  static readonly CODE2: string;
  /** 検索対象カラム CODE3 */
  static readonly CODE3: string;
  /** 検索対象カラム CODE4 */
  static readonly CODE4: string;
  /** 検索対象カラム CODE5 */
  static readonly CODE5: string;
  /** 検索対象カラム NAME */
  static readonly NAME: string;
  /** 検索対象カラム SEARCH_NAME */
  static readonly SEARCH_NAME: string;
  /** 検索対象カラム LOCALE */
  static readonly LOCALE: string;
  /** 検索対象カラム DELETE_FLAG */
  static readonly DELETE_FLAG: string;
  /** 検索対象カラム SORT_KEY */
  static readonly SORT_KEY: string;
  /** 検索対象カラム TERM_CODE */
  static readonly TERM_CODE: string;
  /** 検索対象カラム START_DATE */
  static readonly START_DATE: string;
  /** 検索対象カラム END_DATE */
  static readonly END_DATE: string;
  /** 検索対象カラム RECORD_USER_CD */
  static readonly RECORD_USER_CD: string;
  /** 検索対象カラム RECORD_DATE */
  static readonly RECORD_DATE: string;
  /** 検索対象カラム CREATE_USER_CD */
  static readonly CREATE_USER_CD: string;
  /** 検索対象カラム CREATE_DATE */
  static readonly CREATE_DATE: string;
  ...
  // ==================== addConditionAsTarget 系 ====================

  /**
   * 等号を用いた検索条件を条件群の末尾に追加します。
   *
   * @param searchTarget 検索対象カラム
   * @param value 比較する値
   * @return 成功した場合 true、失敗した場合 false
   */
  addConditionAsTarget(searchTarget: string, value: any): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addConditionAsTarget(searchTarget: string, value: any, operator: string): boolean;

  // ==================== addConditionAsTargetWithIndex 系 ====================
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addConditionAsTargetWithIndex(index: number, searchTarget: string, value: any): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addConditionAsTargetWithIndex(index: number, searchTarget: string, value: any, operator: string): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addLikeAsTarget(searchTarget: string, value: any, conditionType: string): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addLikeAsTargetWithIndex(index: number, searchTarget: string, value: any, conditionType: string): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addNotLikeAsTarget(searchTarget: string, value: any, conditionType: string): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addNotLikeAsTargetWithIndex(index: number, searchTarget: string, value: any, conditionType: string): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addInAsTarget(searchTarget: string, values: any[]): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addInAsTargetWithIndex(index: number, searchTarget: string, values: any[]): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addNotInAsTarget(searchTarget: string, values: any[]): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addNotInAsTargetWithIndex(index: number, searchTarget: string, values: any[]): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addIsNullAsTarget(searchTarget: string): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addIsNullAsTargetWithIndex(index: number, searchTarget: string): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addIsNotNullAsTarget(searchTarget: string): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addIsNotNullAsTargetWithIndex(index: number, searchTarget: string): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addOrderAsTarget(searchTarget: string): boolean;
   ...
   * @return 成功した場合 true、失敗した場合 false
   */
  addOrderAsTargetWithIndex(index: number, searchTarget: string): boolean;
   ...
   *
   * @return 検索条件カラムと値のマッピングオブジェクト
   */
  getSearchTargetValues(): AppCmnSearchCondition.SearchTargetValues;
   ...
   *
   * @param mapper マッピングオブジェクト
   * @return 成功した場合 true、失敗した場合 false
   */
  setSearchTargetValues(mapper: AppCmnSearchCondition.SearchTargetValues): boolean;
   ...
   */
  copy(): AppCmnSearchCondition;
}

declare namespace AppCmnSearchCondition {
  type SearchTargetValues = { [key: string]: any };
}
