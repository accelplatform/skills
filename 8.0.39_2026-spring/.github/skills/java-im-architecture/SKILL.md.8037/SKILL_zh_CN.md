...
> 规约要点（护栏）汇总于 `.github/instructions/java-architecture.instructions.md`。本技能提供从那里引用的完整代码模板、反模式目录，以及贯穿所有层的完整实现示例。
...
通用的类・方法・变量命名规则请参考 `.github/instructions/java-naming.instructions.md`。此处仅记载各层特有的补充说明。
...
- 详情请参考 `.github/instructions/java-logging.instructions.md`
...
日志级别・输出模式・按异常类型的判断方式请参考 `.github/instructions/java-logging.instructions.md`。
...
代码文档（JavaDoc）的书写规约请参考 `.github/instructions/java-javadoc.instructions.md`。
...
- `.github/instructions/java-architecture.instructions.md` - 本技能的规约摘要（始终参考）
- `.github/instructions/java-naming.instructions.md` - 命名规则
- `.github/instructions/java-code-style.instructions.md` - 编码风格
- `.github/instructions/java-javadoc.instructions.md` - JavaDoc 规约
- `.github/instructions/java-logging.instructions.md` - 日志实现规约
- `.github/instructions/java-entity.instructions.md` - Entity 类规约
