...
> 規約の要点（ガードレール）は `.github/instructions/java-architecture.instructions.md` にまとめている。本スキルはそこから参照される、完全なコードテンプレート・アンチパターン集・全レイヤー縦断実装例を提供する。
...
一般的なクラス・メソッド・変数の命名規則は `.github/instructions/java-naming.instructions.md` を参照。ここではレイヤー別の補足のみ記載する。
...
- 詳細は `.github/instructions/java-logging.instructions.md` を参照
...
ログレベル・出力パターン・例外タイプ別の判断は `.github/instructions/java-logging.instructions.md` を参照。
...
コードドキュメント（JavaDoc）の記述規約は `.github/instructions/java-javadoc.instructions.md` を参照。
...
- `.github/instructions/java-architecture.instructions.md` - 本スキルの規約要約（常時参照）
- `.github/instructions/java-naming.instructions.md` - 命名規則
- `.github/instructions/java-code-style.instructions.md` - コーディングスタイル
- `.github/instructions/java-javadoc.instructions.md` - JavaDoc規約
- `.github/instructions/java-logging.instructions.md` - ログ実装規約
- `.github/instructions/java-entity.instructions.md` - Entityクラス規約
