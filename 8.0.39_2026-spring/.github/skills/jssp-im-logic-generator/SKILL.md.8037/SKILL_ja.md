...
allowed-tools: Bash, Read, Write, Glob, mcp__im_logic__list_task_types, mcp__im_logic__get_task_template, mcp__im_logic__list_entities, mcp__im_logic__resolve_entity_schema, mcp__im_logic__list_mapping_functions, mcp__im_logic__get_mapping_function
---
...
```bash
node .github/skills/jssp-im-logic-generator/scripts/build-flow.js \
