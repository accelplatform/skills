...
- `page.request` issued from the Node side is affected by `use.proxy.bypass`, and traffic to `127.0.0.1` becomes a direct connection that may fail
...
- For secure token-related conventions, see `{{AGENT_RULES}}/jssp-security.instructions.md`
