...
- **処理対象者プラグイン**: [assets/simple-authority-exec-event-listener.md](assets/simple-authority-exec-event-listener.md)
...
ユーザが「ワークフローの処理対象者プラグインを作成して」と依頼した場合、この assets のコードを参考にして適切にカスタマイズして生成する。
