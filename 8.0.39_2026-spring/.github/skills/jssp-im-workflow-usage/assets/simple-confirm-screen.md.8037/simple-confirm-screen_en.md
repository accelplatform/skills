...
Following the "Required Verification After Generation" in `SKILL.md`, perform `validate-workflow-code.js` → manual checks → cross-checking against `.github/skills/jssp-imds-theme/reference/`.
