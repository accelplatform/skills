...
The reflection logic is implemented in `.github/skills/bpm-xml-reflector/scripts/bpmn-scripts-reflector.js`. The following is its overview and how to call it.
