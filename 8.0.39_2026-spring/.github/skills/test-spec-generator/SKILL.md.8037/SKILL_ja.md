...
```bash
node .github/skills/test-spec-generator/scripts/build-test-spec.js <spec.jsonのパス> [--out <output.xlsx>]
```
...
```bash
node .github/skills/test-spec-generator/scripts/build-test-spec-html.js <spec.jsonのパス> [--out <output.html>]
```
