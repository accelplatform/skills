...
完全なテンプレートは `.github/skills/java-im-service-layer/references/StandardServiceTemplate.java` を参照。
...
複数リポジトリを1トランザクションで扱う例は `.github/skills/java-im-service-layer/references/MultiRepositoryServiceTemplate.java` を参照。
...
- 完全なサービス実装テンプレートは `.github/skills/java-im-service-layer/SKILL.md` を参照
