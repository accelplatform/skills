...
| `imrepo_entity_*` | Entity reference type (resolved by mcp__im_logic__resolve_entity_schema) | `imrepo_entity_search_imprtl_portlet_info_tables_imprtl_portlet_info` |
