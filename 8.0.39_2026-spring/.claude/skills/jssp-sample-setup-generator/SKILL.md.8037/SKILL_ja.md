...
| 内容 | 参照先 |
|---|---|
| ロール定義 XML | `.claude/skills/jssp-tenant-setup-generator/reference/role.md` |
| 認可ポリシー XML | `.claude/skills/jssp-tenant-setup-generator/reference/authz-policy.md` |
| 認可リソース・リソースグループ XML | `.claude/skills/jssp-tenant-setup-generator/reference/authz-resource.md` |
| 認可サブジェクトグループ XML | `.claude/skills/jssp-tenant-setup-generator/reference/authz-subject-group.md` |
| メニューグループ XML | `.claude/skills/jssp-tenant-setup-generator/reference/menu-group.md` |
| ジョブスケジューラ XML | `.claude/skills/jssp-tenant-setup-generator/reference/job-scheduler.md` |
| DDL の型マッピング | `.claude/skills/jssp-tenant-setup-generator/reference/database-sql.md` |
...
- 認可ポリシーの `subject` 式（`S(b_m_role:...)` 等）は **build スクリプトが内容検証を行わない**。書式は `.claude/skills/jssp-tenant-setup-generator/reference/authz-policy.md` を必ず確認すること。
