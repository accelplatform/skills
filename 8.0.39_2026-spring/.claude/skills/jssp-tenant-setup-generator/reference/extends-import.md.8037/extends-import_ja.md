...
詳細は `.claude/rules/jssp-error-handling.md` および `.claude/skills/jssp-page-generator/reference/post-generation-verification.md`（ステップ 3-7: Transaction.begin の戻り値チェック）も参照。
