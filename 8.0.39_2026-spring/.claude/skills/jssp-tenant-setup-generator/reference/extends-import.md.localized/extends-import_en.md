...
For details, also see `{{AGENT_RULES}}/jssp-error-handling.md` and `jssp-page-generator/reference/post-generation-verification.md` (step 3-7: checking the return value of Transaction.begin).
