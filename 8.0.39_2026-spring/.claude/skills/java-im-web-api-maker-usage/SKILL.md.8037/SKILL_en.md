...
2. Design the package, factory class name, and Endpoint class name (following `.claude/rules/java-naming.md`. The Endpoint class is `Xxx` + `Endpoint`, and the factory class is `Xxx` + `EndpointFactory`)
...
11. Whether it complies with `.claude/rules/java-naming.md` / `java-code-style.md` / `java-javadoc.md`
