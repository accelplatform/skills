...
コーディングに関する規約は `.claude/rules/` 配下に配置している。ファイル一覧と内容は `.claude/rules/README.md` を参照すること。

### 主要なスキルセット

各種スキルセットは `.claude/skills/` 配下に配置している。スキル一覧と内容は `.claude/skills/README.md` を参照すること。
