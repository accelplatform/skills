...
- Refer to `.agents/skills/jssp-jest-test/SKILL.md` for details
...
For Playwright tests, prefer the `expectNavigated()` helper defined in `.agents/skills/jssp-playwright-test/assets/test-helpers.md`.
