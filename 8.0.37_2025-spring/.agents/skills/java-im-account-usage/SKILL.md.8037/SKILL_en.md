...
No dedicated Java convention defining exception-handling policy exists under `.agents/requirements` (as of 2026). All of `AccountInfoManager`'s and `AccountPasswordAdapter`'s exceptions are checked exceptions (described below); follow the business-exception-wrapping pattern in `assets/account-basic-usage.md`.
...
6. Confirm compliance with `.agents/requirements/java-naming/AGENTS.md` / `java-code-style.md` / `java-javadoc.md`
...
7. Whether the code complies with `.agents/requirements/java-naming/AGENTS.md` / `java-code-style.md` / `java-javadoc.md`
