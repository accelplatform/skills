...
本技能生成批处理（仅 `.js`，无画面）。全局视图请参阅 `.agents/requirements/README.md`。
...
执行 `.agents/skills/jssp-page-generator/reference/post-generation-verification.md` 的步骤 1～3（步骤 4 的画面验证对作业不适用）。
