...
| 内容 | 参照位置 |
|---|---|
| 角色定义 XML | `.agents/skills/jssp-tenant-setup-generator/reference/role.md` |
| 授权策略 XML | `.agents/skills/jssp-tenant-setup-generator/reference/authz-policy.md` |
| 授权资源·资源组 XML | `.agents/skills/jssp-tenant-setup-generator/reference/authz-resource.md` |
| 授权主体组 XML | `.agents/skills/jssp-tenant-setup-generator/reference/authz-subject-group.md` |
| 菜单组 XML | `.agents/skills/jssp-tenant-setup-generator/reference/menu-group.md` |
| 任务调度器 XML | `.agents/skills/jssp-tenant-setup-generator/reference/job-scheduler.md` |
| DDL 的类型映射 | `.agents/skills/jssp-tenant-setup-generator/reference/database-sql.md` |
...
- 授权策略的 `subject` 表达式（如 `S(b_m_role:...)`）**build 脚本不会对其内容进行校验**。务必参照 `.agents/skills/jssp-tenant-setup-generator/reference/authz-policy.md` 确认书式。
