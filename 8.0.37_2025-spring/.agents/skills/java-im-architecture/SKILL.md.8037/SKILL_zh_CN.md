...
> 规约要点（护栏）汇总于 `.agents/requirements/java-architecture/AGENTS.md`。本技能提供从那里引用的完整代码模板、反模式目录，以及贯穿所有层的完整实现示例。
...
通用的类・方法・变量命名规则请参考 `.agents/requirements/java-naming/AGENTS.md`。此处仅记载各层特有的补充说明。
...
- 详情请参考 `.agents/requirements/java-logging/AGENTS.md`
...
日志级别・输出模式・按异常类型的判断方式请参考 `.agents/requirements/java-logging/AGENTS.md`。
...
代码文档（JavaDoc）的书写规约请参考 `.agents/requirements/java-javadoc/AGENTS.md`。
...
- `.agents/requirements/java-architecture/AGENTS.md` - 本技能的规约摘要（始终参考）
- `.agents/requirements/java-naming/AGENTS.md` - 命名规则
- `.agents/requirements/java-code-style/AGENTS.md` - 编码风格
- `.agents/requirements/java-javadoc/AGENTS.md` - JavaDoc 规约
- `.agents/requirements/java-logging/AGENTS.md` - 日志实现规约
- `.agents/requirements/java-entity/AGENTS.md` - Entity 类规约
