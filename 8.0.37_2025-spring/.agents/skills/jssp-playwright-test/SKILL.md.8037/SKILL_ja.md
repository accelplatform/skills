...
3. `.agents/requirements/jssp-testing/AGENTS.md` のテスト観点に基づいてテストケースを設計する
...
| `.agents/requirements/jssp-testing/AGENTS.md` | テスト観点・設定規約 |
...
- テスト観点の詳細は `.agents/requirements/jssp-testing/AGENTS.md` を参照すること
