...
The reflection logic is implemented in `.agents/skills/bpm-xml-reflector/scripts/bpmn-scripts-reflector.js`. The following is its overview and how to call it.
...
```javascript
var reflector = require('.agents/skills/bpm-xml-reflector/scripts/bpmn-scripts-reflector');
