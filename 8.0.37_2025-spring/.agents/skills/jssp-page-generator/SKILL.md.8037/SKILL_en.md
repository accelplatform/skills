...
- [ ] [jssp-2way-sql](../../../requirements/jssp-2way-sql/AGENTS.md) has been read and understood
...
This skill generates both `.js` (function containers) and `.html` (presentation pages), so many conventions apply. See the "Convention File List (One-Line Summary + Scope Tag)" in `.agents/requirements/README.md` for the full picture. Convention-specific priorities for this skill:
...
|-----------|----------------|
| Textbox | `.agents/skills/jssp-imds-theme/reference/imds-html-textbox.md` |
| Textarea | `.agents/skills/jssp-imds-theme/reference/imds-html-textarea.md` |
| Select | `.agents/skills/jssp-imds-theme/reference/imds-html-select.md` |
| Checkbox | `.agents/skills/jssp-imds-theme/reference/imds-html-checkbox.md` |
| Radio Button | `.agents/skills/jssp-imds-theme/reference/imds-html-radio.md` |
| Button | `.agents/skills/jssp-imds-theme/reference/imds-html-button.md` |
| Table | `.agents/skills/jssp-imds-theme/reference/imds-html-table.md` |
| Dialog | `.agents/skills/jssp-imds-theme/reference/imds-html-dialog.md` |
| Dialog + Form (new / edit, etc.) | `.agents/skills/jssp-imds-theme/reference/imds-html-dialog-form.md` |
| Pagination | `.agents/skills/jssp-imds-theme/reference/imds-html-pagination.md` |
| Field (with label) | `.agents/skills/jssp-imds-theme/reference/imds-html-field.md` |
| Field Group | `.agents/skills/jssp-imds-theme/reference/imds-html-field-group.md` |
| Tab | `.agents/skills/jssp-imds-theme/reference/imds-html-tabs.md` |
| Accordion | `.agents/skills/jssp-imds-theme/reference/imds-html-accordion.md` |
| Calendar Input | `.agents/skills/jssp-imds-theme/reference/imui-html-calendar.md` |
| Banner Message | `.agents/skills/jssp-imds-theme/reference/imds-html-banner-message.md` |
| Inline Message | `.agents/skills/jssp-imds-theme/reference/imds-html-inline-message.md` |

Other components are stored under `.agents/skills/jssp-imds-theme/reference/`.

---

### Step 4: Generate Function Container and Routing

Refer to `.agents/requirements/jssp-function-container/AGENTS.md` and `.agents/requirements/jssp-presentation-page/AGENTS.md` to generate code.
...
- **Omitting JSDoc comments (`/** ... */`) or section delimiter comments (`// ===...===`) included in the asset.** Even if they appear verbose, the convention (`.agents/requirements/jssp-function-container/AGENTS.md`) treats them as required. Keeping them clarifies the intent of each function inline, which makes subsequent reviews and modifications easier. Comments in assets must be copied as-is in principle. If changes are needed, only rewrite the content for the relevant feature; do not delete them.
