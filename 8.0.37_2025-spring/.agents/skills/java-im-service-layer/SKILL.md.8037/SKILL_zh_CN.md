...
> 规约的要点（护栏）汇总在 `.agents/requirements/java-service-layer/AGENTS.md` 中。本技能从那里被引用，提供完整的代码模板。
...
- `.agents/requirements/java-service-layer/AGENTS.md` - 本技能的规约摘要（始终参考）
- `.agents/requirements/java-architecture/AGENTS.md` - 架构原则・分层结构
- `.agents/requirements/java-entity/AGENTS.md` - 实体・领域模型定义
- `.agents/requirements/java-logging/AGENTS.md` - 日志实现规则
