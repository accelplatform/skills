...
| Author a custom approver plugin (MCP `mcp__im_workflow__resolve_authority`) | Custom conditions that cannot be expressed by organization / post / role / public group, e.g., "users hired after 2026/10/01" | Restricted use |
