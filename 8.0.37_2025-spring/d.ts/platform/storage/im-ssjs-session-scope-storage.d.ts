/**
 * SessionScopeStorage アクセスクラス。
 *
 * セッション有効期限切れ時に自動削除されるストレージです。
 *
 * @since 8.0.37 (2025 Spring)
 * @see https://api.intra-mart.jp/iap/apilist-ssjs/doc/platform/SessionScopeStorage/index.html
 */
declare class SessionScopeStorage {
  /**
   * 指定したパスを示す、SessionScopeStorage クラスのインスタンスを作成します。
   *
   * @param path セッションスコープストレージのパス
   */
  constructor(path: string);

  /**
   * 指定した親・子のパスを示す、SessionScopeStorage クラスのインスタンスを作成します。
   *
  ...
  /**
   * 指定した Storage と同じパスを示す、SessionScopeStorage クラスのインスタンスを作成します。
   *
   * @param storage セッションスコープストレージ
   */
   ...
   *
   * @param to コピー先の SessionScopeStorage
  ...
  /**
   * ディレクトリ内のディレクトリを示す SessionScopeStorage コレクションを取得します。
   *
   * @param recursive true の場合、再帰的に探索します
   * @return SessionScopeStorage の配列
   */
  ...
  /**
   * ディレクトリ内のファイルを示す SessionScopeStorage コレクションを取得します。
   *
   * @param recursive true の場合、再帰的に探索します
   * @return SessionScopeStorage の配列
   */
  ...
  /**
   * 親の SessionScopeStorage を返します。
   *
   * @return 親ディレクトリの SessionScopeStorage
   */
  ...
  /**
   * 対象の SessionScopeStorage からの相対パスを返します。
   *
   * @param target 基準となる SessionScopeStorage
   * @return 相対パス文字列
   */
  getRelativePath(target: SessionScopeStorage): string;

  /**
   * ルートの SessionScopeStorage を返します。
   *
   * @return ルートディレクトリの SessionScopeStorage
   */
  ...
  /**
   * ディレクトリ内のファイルおよびディレクトリを示す SessionScopeStorage コレクションを取得します。
   *
   * @param filterOrRecursive Boolean の場合は再帰探索フラグ、Function の場合はフィルタ関数
   * @return SessionScopeStorage の配列
   */
  listStorages(filterOrRecursive?: boolean | ((path: string) => boolean)): SessionScopeStorage[];
  ...
  /**
   * 相対パスを解決した SessionScopeStorage を返します。
   *
   * @param other 相対パス
   * @return 解決された SessionScopeStorage
   */
