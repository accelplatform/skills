 ...
 * 完了案件情報オブジェクト。
 *
 * 完了案件情報の取得処理で、処理結果である案件情報を保存するためのオブジェクトです。
 * データベーステーブル「imw_t_cpl_matter」と「imw_t_cpl_matter_locale」のデータが設定されます。
 *
 * 値の取得時にのみ使用します（新規作成・更新・削除には使用しません）。
 *
 * @since 8.0.37 (2025 Spring)
 * @see https://api.intra-mart.jp/iap/apilist-ssjs/doc/im_workflow/CplMatterInfo/index.html
 */
interface CplMatterInfo {
  // --- NOT NULL プロパティ ---
