 ...
 * @see https://api.intra-mart.jp/iap/apilist-ssjs/doc/im_workflow/TargetAuthActInfo/index.html
 */
interface TargetAuthActInfo {
  // --- NOT NULL プロパティ ---
  ...
  /** 代理元対象コード */
  readonly originalActTargetCode?: string;
  /** 代理元対象種別 */
  readonly originalActTargetType?: string;
  /** 代理元ユーザコード */
