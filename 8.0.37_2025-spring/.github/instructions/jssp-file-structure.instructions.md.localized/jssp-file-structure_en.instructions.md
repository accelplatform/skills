---
applyTo: "src/main/jssp/**/*.js,src/main/jssp/**/*.html,src/main/conf/routing-jssp-config/**/*.xml,src/test/jssp/**/*.test.js"
description: "各ファイルの配置場所"
---
...
<routing-jssp-config
  ...
  <!-- Default value for authorization settings -->
...
### mapper Attribute Guidelines

| mapper Value | Usage | Description |
|--------------|-------|-------------|
| `welcome-all` | Development / public screens | Skips authorization processing (accessible to anyone) |
| Not specified | Production environment | Access controlled according to authorization settings |

**Note**: In production environments, avoid using `welcome-all` and apply appropriate authorization settings.
