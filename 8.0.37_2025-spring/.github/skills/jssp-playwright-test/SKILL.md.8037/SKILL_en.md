...
| `.github/instructions/jssp-testing.instructions.md` | Test perspectives and configuration conventions |
...
- Refer to `.github/instructions/jssp-testing.instructions.md` for details on test perspectives
