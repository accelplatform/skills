...
详情请参见 `.github/instructions/jssp-error-handling.instructions.md` 和 `jssp-page-generator/reference/post-generation-verification.md`（步骤 3-7：Transaction.begin 的返回值检查）。
