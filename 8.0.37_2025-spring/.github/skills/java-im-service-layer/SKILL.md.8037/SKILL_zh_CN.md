...
> 规约的要点（护栏）汇总在 `.github/instructions/java-service-layer.instructions.md` 中。本技能从那里被引用，提供完整的代码模板。
...
- `.github/instructions/java-service-layer.instructions.md` - 本技能的规约摘要（始终参考）
- `.github/instructions/java-architecture.instructions.md` - 架构原则・分层结构
- `.github/instructions/java-entity.instructions.md` - 实体・领域模型定义
- `.github/instructions/java-logging.instructions.md` - 日志实现规则
