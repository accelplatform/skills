...
| `.github/instructions/java-logging.instructions.md` | 🟡 When implementing logging (`Logger.getLogger(XxxClass.class)`) |
...
4. Confirm compliance with `.github/instructions/java-naming.instructions.md` / `java-code-style.md` / `java-javadoc.md`
...
- Either let `IOException` propagate via `throws IOException` or wrap it in a business exception. Write error messages descriptively in Japanese, following the conventions in `.github/instructions/java-javadoc.instructions.md`
...
5. Whether the code complies with `.github/instructions/java-naming.instructions.md` / `java-code-style.md` / `java-javadoc.md`
