...
No dedicated Java convention defining exception-handling policy exists under `.github/instructions` (as of 2026). All of `NewLock`'s exceptions are unchecked (described below); follow the business-exception-wrapping pattern in `assets/lock-basic-usage.md`.
