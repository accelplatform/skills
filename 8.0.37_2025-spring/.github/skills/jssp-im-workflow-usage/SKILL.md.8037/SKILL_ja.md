...
- **プレゼンテーションページ（.html）は `.github/instructions/jssp-presentation-page.instructions.md` のコーディング規約に従うこと**。特にバリデーション実装は規約準拠が必須。生成完了後、`reference/screen-generation-checklist.md` でセルフチェックを行うこと
