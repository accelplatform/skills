...
> The key points of the convention (the guardrails) are summarized in `.github/instructions/java-architecture.instructions.md`. This skill provides the complete code templates, anti-pattern catalog, and a full-stack implementation example referenced from there.
...
For general class/method/variable naming rules, see `.github/instructions/java-naming.instructions.md`. Only layer-specific additions are described here.
...
- See `.github/instructions/java-logging.instructions.md` for details
...
See `.github/instructions/java-logging.instructions.md` for log levels, output patterns, and how to decide by exception type.
...
For code documentation (JavaDoc) writing conventions, see `.github/instructions/java-javadoc.instructions.md`.
...
- `.github/instructions/java-architecture.instructions.md` - Convention summary for this skill (always consult)
- `.github/instructions/java-naming.instructions.md` - Naming conventions
- `.github/instructions/java-code-style.instructions.md` - Coding style
- `.github/instructions/java-javadoc.instructions.md` - JavaDoc conventions
- `.github/instructions/java-logging.instructions.md` - Logging implementation conventions
- `.github/instructions/java-entity.instructions.md` - Entity class conventions
