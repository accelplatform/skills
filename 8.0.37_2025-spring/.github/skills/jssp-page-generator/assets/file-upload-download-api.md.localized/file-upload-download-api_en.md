...
In production environments, configure authorization instead of `welcome-all`.
...
- `{{AGENT_RULES}}/jssp-security.instructions.md` - Input validation and path traversal prevention policy
