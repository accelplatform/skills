...
No dedicated Java convention defining an `IOException` wrapping policy exists under `.github/instructions` (as of 2026). For exception handling when using `get()`, follow the pattern in `assets/identifier-basic-usage.md`.
...
4. Whether the code complies with `.github/instructions/java-naming.instructions.md` / `java-code-style.md` / `java-javadoc.md`
