...
- See "Basic Structure" at the top of this page for full details. For portlet-specific additions (omitting the header/footer, etc.), see `.claude/skills/jssp-page-generator/assets/simple-portlet.md`
