...
```bash
node .claude/skills/test-spec-generator/scripts/build-test-spec.js <spec.json路径> [--out <output.xlsx>]
```
...
```bash
node .claude/skills/test-spec-generator/scripts/build-test-spec-html.js <spec.json路径> [--out <output.html>]
```
