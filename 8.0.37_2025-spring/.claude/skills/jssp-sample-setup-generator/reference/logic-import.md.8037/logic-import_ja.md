...
`.claude/skills/jssp-tenant-setup-generator/reference/logic-import.md` を参照。
...
`.claude/skills/jssp-tenant-setup-generator/reference/logic-import.md` の「ルーティング向け認可ポリシーの投入順序」を参照。
