...
If unspecified, it is automatically converted from the class name by `NameConverter`, but this project requires explicit specification (see `.agents/requirements/java-entity/AGENTS.md`).
...
Per `.agents/requirements/java-entity/AGENTS.md`, this project prohibits using anything other than `GenerationType.APPLICATION`.
