...
詳細は `.agents/requirements/jssp-error-handling/AGENTS.md` および `.agents/skills/jssp-page-generator/reference/post-generation-verification.md`（ステップ 3-7: Transaction.begin の戻り値チェック）も参照。
