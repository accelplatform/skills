...
3. 根据 `.agents/requirements/jssp-testing/AGENTS.md` 的测试观点设计测试用例
...
| `.agents/requirements/jssp-testing/AGENTS.md` | 测试观点和配置规范 |
...
- 测试观点的详情请参考 `.agents/requirements/jssp-testing/AGENTS.md`
