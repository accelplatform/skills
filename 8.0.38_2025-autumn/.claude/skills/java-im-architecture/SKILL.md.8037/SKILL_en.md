...
> The key points of the convention (the guardrails) are summarized in `.claude/rules/java-architecture.md`. This skill provides the complete code templates, anti-pattern catalog, and a full-stack implementation example referenced from there.
...
For general class/method/variable naming rules, see `.claude/rules/java-naming.md`. Only layer-specific additions are described here.
...
- See `.claude/rules/java-logging.md` for details
...
See `.claude/rules/java-logging.md` for log levels, output patterns, and how to decide by exception type.
...
For code documentation (JavaDoc) writing conventions, see `.claude/rules/java-javadoc.md`.
...
- `.claude/rules/java-architecture.md` - Convention summary for this skill (always consult)
- `.claude/rules/java-naming.md` - Naming conventions
- `.claude/rules/java-code-style.md` - Coding style
- `.claude/rules/java-javadoc.md` - JavaDoc conventions
- `.claude/rules/java-logging.md` - Logging implementation conventions
- `.claude/rules/java-entity.md` - Entity class conventions
