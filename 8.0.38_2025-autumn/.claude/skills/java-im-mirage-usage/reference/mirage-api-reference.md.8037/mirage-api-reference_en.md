...
If unspecified, it is automatically converted from the class name by `NameConverter`, but this project requires explicit specification (see `.claude/rules/java-entity.md`).
...
Per `.claude/rules/java-entity.md`, this project prohibits using anything other than `GenerationType.APPLICATION`.
