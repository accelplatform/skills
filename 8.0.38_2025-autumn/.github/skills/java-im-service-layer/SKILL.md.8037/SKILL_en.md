...
> The essential points of the convention (guardrails) are summarized in `.github/instructions/java-service-layer.instructions.md`. This skill is referenced from there and provides the complete code templates.
...
- `.github/instructions/java-service-layer.instructions.md` - Convention summary for this skill (always reference)
- `.github/instructions/java-architecture.instructions.md` - Architecture principles and layer structure
- `.github/instructions/java-entity.instructions.md` - Entity and domain model definitions
- `.github/instructions/java-logging.instructions.md` - Logging implementation rules
