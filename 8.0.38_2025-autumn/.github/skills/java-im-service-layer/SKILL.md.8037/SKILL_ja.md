...
> 規約の要点（ガードレール）は `.github/instructions/java-service-layer.instructions.md` にまとめている。本スキルはそこから参照される、完全なコードテンプレートを提供する。
...
- `.github/instructions/java-service-layer.instructions.md` - 本スキルの規約要約（常時参照）
- `.github/instructions/java-architecture.instructions.md` - アーキテクチャ原則・レイヤ構造
- `.github/instructions/java-entity.instructions.md` - エンティティ・ドメインモデル定義
- `.github/instructions/java-logging.instructions.md` - ログ実装ルール
