...
遵循 `.github/instructions/java-entity.instructions.md` 的规约（public 字段、无参构造函数、4个审计项目字段）。
...
- `@PrimaryKey` 的 `generationType` 在本项目中仅使用 `GenerationType.APPLICATION`（参见 `.github/instructions/java-entity.instructions.md`）
