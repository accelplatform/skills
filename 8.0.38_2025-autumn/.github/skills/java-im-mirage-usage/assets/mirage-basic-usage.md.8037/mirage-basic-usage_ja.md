...
`.github/instructions/java-entity.instructions.md` の規約（publicフィールド・引数なしコンストラクタ・監査項目4フィールド）に従う。
...
- `@PrimaryKey` の `generationType` は本プロジェクトでは `GenerationType.APPLICATION` のみ使用する（`.github/instructions/java-entity.instructions.md` 参照）
