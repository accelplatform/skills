...
| Content | Reference |
|---|---|
| Role definition XML | `.github/skills/jssp-tenant-setup-generator/reference/role.md` |
| Authz policy XML | `.github/skills/jssp-tenant-setup-generator/reference/authz-policy.md` |
| Authz resource / resource group XML | `.github/skills/jssp-tenant-setup-generator/reference/authz-resource.md` |
| Authz subject group XML | `.github/skills/jssp-tenant-setup-generator/reference/authz-subject-group.md` |
| Menu group XML | `.github/skills/jssp-tenant-setup-generator/reference/menu-group.md` |
| Job Scheduler XML | `.github/skills/jssp-tenant-setup-generator/reference/job-scheduler.md` |
| DDL type mapping | `.github/skills/jssp-tenant-setup-generator/reference/database-sql.md` |
...
- The `subject` expression in authz policies (e.g. `S(b_m_role:...)`) is **not content-validated by the build script**. Always check the format in `.github/skills/jssp-tenant-setup-generator/reference/authz-policy.md`.
