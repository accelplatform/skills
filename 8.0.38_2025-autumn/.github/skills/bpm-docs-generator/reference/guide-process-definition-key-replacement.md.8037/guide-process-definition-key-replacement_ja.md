...
- 実行例: `{{RUNTIME}} .github/skills/bpm-docs-generator/scripts/validate-process-key-replacement.js <processNm-prompt/diagram.bpmn> --json`
...
- 反映時の既存キー再利用・例外時の扱い・記録更新は bpm-xml-reflectorの`.github/skills/bpm-xml-reflector/reference/bpmn-specs-reflector.md` を正とする。
