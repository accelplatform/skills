...
5. See `.github/skills/java-im-architecture/references/anti-patterns.md` for violation examples and fixes
...
See `.github/skills/java-im-architecture/references/full-stack-example.md` for an implementation example spanning all layers (DDL → Entity → DAO → Repository → Service → UseCase → Endpoint).

## Naming Conventions

Basic rules for class/method/variable names are in `java-naming.instructions.md`. This section only supplements class types that span multiple layers.
...
- Exception conversion must wrap a lower layer's exception in the upper layer's exception, preserving the cause (see `java-service-layer.instructions.md` for the service layer's details)
- Whether to log depends on the exception type. See "Log Level Decisions by Exception Type" in `java-logging.instructions.md`
...
- See `.github/skills/java-im-architecture/SKILL.md` for the full factory implementation template
...
- **Required** Do not log sensitive information (passwords, tokens, personal data) — see `java-logging.instructions.md`
...
See `java-javadoc.instructions.md` for class/method JavaDoc.
...
- `java-naming.instructions.md` - Naming conventions
- `java-code-style.instructions.md` - Coding style
- `java-javadoc.instructions.md` - JavaDoc conventions
- `java-logging.instructions.md` - Logging conventions
- `java-service-layer.instructions.md` - Service layer implementation conventions
- `java-entity.instructions.md` - Entity class conventions
- See `.github/skills/java-im-architecture/SKILL.md` for the full anti-pattern catalog and the full-stack implementation example
