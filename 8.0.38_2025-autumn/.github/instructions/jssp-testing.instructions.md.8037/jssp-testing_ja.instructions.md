---
applyTo: "src/test/jssp/**/*.test.js,src/test/e2e/**/*.spec.ts,playwright.config.ts,jest.config.js"
description: "テスト規約（単体テストの実装方針）"
---
...
- 詳細は `.github/skills/jssp-jest-test/SKILL.md` を参照すること
...
Playwright テストでは `.github/skills/jssp-playwright-test/assets/test-helpers.md` の `expectNavigated()` ヘルパー使用を推奨する。
